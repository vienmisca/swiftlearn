...
<body style="background: linear-gradient(to right, #008CFF, #0073D1);" class="h-screen">
  ...
  <div class="flex h-screen w-screen">
    <!-- Sidebar Login -->
    <div class="w-[420px] h-full bg-white rounded-r-[60px] shadow-xl p-10 flex flex-col justify-between">
      
      <div>
        <div class="text-center mb-10">
          <h1 class="text-3xl font-bold text-gray-900 mb-1">Login</h1>
        ...
        <label for="email" class="block text-sm mb-1 text-gray-700">Email address</label>
        <input
          type="email"
          name="email"
          id="email"
        ...
        <input
          ...
          class="w-full mb-8 p-3 rounded-full border border-gray-300 shadow-sm focus:outline-none focus:ring focus:ring-indigo-200"
          required
        >
      ...
      <div class="text-center mt-10">
        <a href="#" class="text-sm text-gray-500 hover:text-indigo-600">Login sebagai Mentor/Admin</a>
      </div>
    </div>
